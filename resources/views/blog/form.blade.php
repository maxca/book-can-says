    ...
    <form action="{{url('/create-book')}}" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input name="publisher_name" type="text" class="form-control" id="exampleInputPassword1"
                   placeholder="Publisher" value="{{old('publisher_name')}}">
        ...
        <div class="form-group">
            ...
            <input name="total_page" type="text" class="form-control" placeholder="total page" value="{{old('total_page')}}">
        ...
        <div class="form-group">
            ...
            <input name="total_chapter" type="number" class="form-control" placeholder="total chapter" value="{{old('total_chapter')}}">
